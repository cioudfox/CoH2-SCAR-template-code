		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>Ever wish to experience a mod that breaks the game in so many directions?
Introducing the Oorah! mod where I break the game so you won't need to. Every single non doctrinal unit(except the British) have been modified in ways to break the game. Tank duplicating tanks? Jeep transforming bazookas? Let your imagination run wild in this mod pack of "balanced" changes!</Description>
					<Hidden>false</Hidden>
					<Name>Oorah!</Name>
				</d2p1:anyType>
			</Children>
	...
	<Guid>389a3a77-a845-40ed-8562-74d10ffa463f</Guid>
